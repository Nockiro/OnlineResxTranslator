...
namespace Admin
{
    public partial class Admin_Info : PageBase
    {
        ...
        protected void gvUsers_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            sqlManager.OpenConnection();
            // update user table
            sqlManager.UpdateTable("AspNetUsers", "id = '" + id + "'",
            ...
            sqlManager.UpdateOrInsertIntoTable("TrUserLanguages", new KeyValuePair<string, string>("UserID", id),
            ...
            sqlManager.DeleteRow("TrUserProjects", "UserID = '" + id + "'");
            if (userProjects != "")
                foreach (string proj in userProjects.Split(','))
                {
                    ...
                    sqlManager.InsertIntoTable("TrUserProjects", new KeyValuePair<string, string>("UserID", id), new KeyValuePair<string, string>("ProjID", projID));
                }
        ...
        protected void gvUsers_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sqlManager.OpenConnection();
            sqlManager.DeleteRow("AspNetUsers", "ID = '" + id + "'");
            sqlManager.CloseConnection();
        ...
        protected void ShowProjectData()
        {
            ...
            projectList = sqlManager.SelectFromTable("TrProjects", "id", "project", "folder",
                @"ftps = STUFF((
        ...
        protected void gvProjects_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                sqlManager.InsertIntoTable("TrProjects", new KeyValuePair<string, string>("project", project_name),
                    new KeyValuePair<string, string>("folder", project_folder));
            }
            else
            { // otherwise update it
                sqlManager.UpdateTable("TrProjects", "id = " + id,
            ...
            sqlManager.DeleteRow("TrProjectFTPTargets", "ProjID = " + id);
            ...
            if (ftp != "")
                foreach (string ftpTarget in ftp.Split(','))
                {
                    ...
                    if (int.TryParse(ftpTarget, out int ftpTargetID))
                        sqlManager.InsertIntoTable("TrProjectFTPTargets", new KeyValuePair<string, string>("TargetID", ftpTargetID.ToString()), new KeyValuePair<string, string>("ProjID", id.ToString()));
                }
        ...
        protected void gvProjects_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sqlManager.OpenConnection();
            sqlManager.DeleteRow("TrProjects", "ID = " + id);
            sqlManager.CloseConnection();
        ...
        protected void ShowFTPData()
        {
            ...
            ftpList = sqlManager.SelectFromTable("TrFTPTargets", "id", "server", "username", "password", "path", "ssl");
        ...
        protected void gvFtps_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                sqlManager.InsertIntoTable("TrFTPTargets",
            ...
            else
            {
                ...
                // otherwise update it
                sqlManager.UpdateTable("TrFTPTargets", "id = " + id, valuePairs.ToArray());
            }
        ...
        protected void gvFtps_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sqlManager.OpenConnection();
            sqlManager.DeleteRow("TrFTPTargets", "id = " + id);
            sqlManager.CloseConnection();
